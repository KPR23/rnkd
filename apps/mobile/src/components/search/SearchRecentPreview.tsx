  ...
  return (
    <View className="flex w-full flex-col gap-2.5">
      <View className="flex-row items-center justify-between">
        <AppText className="text-sm leading-5" weight="medium" color={colors.textSecondary}>
          Recent searches
        </AppText>
        {onViewAllPress ? (
          <TouchableOpacity activeOpacity={0.7} onPress={onViewAllPress}>
            <AppText className="text-sm leading-5" weight="medium" color={colors.primary}>
              View all
            </AppText>
          </TouchableOpacity>
        ) : null}
      ...
      >
        <AppText className="text-sm leading-5" weight="medium" color={colors.text}>
          {previewSearch}
        </AppText>
